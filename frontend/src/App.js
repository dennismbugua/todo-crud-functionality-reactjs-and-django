...
class App extends Component{
  ...
  editItem = (item) => {this.state({activeItem: item, modal: !this.state.modal})}
  ...
  renderTabList = () => {
    return(
      <div className='nav nav-tabs'>
        <span className={this.state.viewCompleted ? 'nav-link active' : 'nav-link'} onClick={() => this.displayCompleted(true)}>Completed</span>
